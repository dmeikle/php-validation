...
class EmailValidatorTest extends BaseTest
{
     ...
     * @return void
     */
    public function testValidEmail_shouldReturnTrue() {
     ...
     * @return void
     */
    public function testInvalidEmail_shouldReturnFalse() {
        $validator = new EmailValidator();

        $result = $validator->validate(Constants::INVALID_EMAIL_ADDRESS);
     ...
     * @return void
     */
    public function testValidEmailWithLimit_shouldReturnTrue() {
        $validator = new EmailValidator();
        $result = $validator->setParams([
            ParamFactory::MAX_LENGTH => Constants::INTEGER_VALUE_15
        ])->validate(Constants::SHORT_EMAIL_ADDRESS);
    ...
    public function testExceedsMax_shouldReturnFalse() {
        ...
        $result = $validator->setParams([
            ParamFactory::MAX_LENGTH => Constants::INTEGER_VALUE_15
        ])->validate(Constants::LONG_EMAIL_ADDRESS);
